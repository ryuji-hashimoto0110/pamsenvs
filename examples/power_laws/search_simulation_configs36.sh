...
initial_seed=42
base_config_path="base_config36.json"
target_variables_config_path="target_variables_config36.json"
temp_txts_path="../../datas/artificial_datas/flex_txt/temp36"
temp_tick_dfs_path="../../datas/artificial_datas/flex_csv/temp36"
