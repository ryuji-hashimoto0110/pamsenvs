initial_seed=42
configs_folder_path="."
config_names="2_10.json" 
txt_save_folder_paths="../../datas/artificial_datas/flex_txt/2_10"
num_simulations=1
resample_rule="1min"
tick_dfs_folder_paths="../../datas/artificial_datas/flex_csv/2_10"
ohlcv_dfs_folder_paths="../../datas/artificial_datas/intraday/flex_ohlcv/1min/2_10"
...
figs_save_paths="../../imgs/compare_stylized_facts/2_10"
results_save_paths="../../stylized_facts/results/2_10.csv"
