...
configs_folder_path="."
config_names="1.json" 
txt_save_folder_paths="../../datas/artificial_datas/flex_txt/1"
num_simulations=1
resample_rule="1min"
tick_dfs_folder_paths="../../datas/artificial_datas/flex_csv/1"
ohlcv_dfs_folder_paths="../../datas/artificial_datas/intraday/flex_ohlcv/1min/1"
...
figs_save_paths="../../imgs/compare_stylized_facts/1"
results_save_paths="../../stylized_facts/results/1.csv"
