...
configs_folder_path="."
config_names="3.json" 
txt_save_folder_paths="../../datas/artificial_datas/flex_txt/3"
num_simulations=1
resample_rule="1min"
tick_dfs_folder_paths="../../datas/artificial_datas/flex_csv/3"
ohlcv_dfs_folder_paths="../../datas/artificial_datas/intraday/flex_ohlcv/1min/3"
...
figs_save_paths="../../imgs/compare_stylized_facts/3"
results_save_paths="../../stylized_facts/results/3.csv"
