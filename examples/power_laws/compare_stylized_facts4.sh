...
configs_folder_path="."
config_names="4.json" 
txt_save_folder_paths="../../datas/artificial_datas/flex_txt/4"
num_simulations=2000
resample_rule="1min"
tick_dfs_folder_paths="../../datas/artificial_datas/flex_csv/4"
ohlcv_dfs_folder_paths="../../datas/artificial_datas/intraday/flex_ohlcv/1min/4"
...
figs_save_paths="../../imgs/compare_stylized_facts/4"
results_save_paths="../../stylized_facts/results/4.csv"
