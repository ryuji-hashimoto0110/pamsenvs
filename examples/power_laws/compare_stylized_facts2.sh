...
configs_folder_path="."
config_names="2.json" 
txt_save_folder_paths="../../datas/artificial_datas/flex_txt/2"
num_simulations=1000
resample_rule="1min"
tick_dfs_folder_paths="../../datas/artificial_datas/flex_csv/2"
ohlcv_dfs_folder_paths="../../datas/artificial_datas/intraday/flex_ohlcv/1min/2"
...
figs_save_paths="../../imgs/compare_stylized_facts/2"
results_save_paths="../../stylized_facts/results/2.csv"
