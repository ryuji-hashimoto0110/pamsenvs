...
configs_folder_path="."
config_names="5.json" 
txt_save_folder_paths="../../datas/artificial_datas/flex_txt/5"
num_simulations=1000
resample_rule="1min"
tick_dfs_folder_paths="../../datas/artificial_datas/flex_csv/5"
ohlcv_dfs_folder_paths="../../datas/artificial_datas/intraday/flex_ohlcv/1min/5"
...
figs_save_paths="../../imgs/compare_stylized_facts/5"
results_save_paths="../../stylized_facts/results/5.csv"
