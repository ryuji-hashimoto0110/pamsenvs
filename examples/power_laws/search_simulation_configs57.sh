...
initial_seed=42
base_config_path="base_config57.json"
target_variables_config_path="target_variables_config57.json"
temp_txts_path="../../datas/artificial_datas/flex_txt/temp57"
temp_tick_dfs_path="../../datas/artificial_datas/flex_csv/temp57"
temp_ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/1min/temp57"
temp_all_time_ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/all_time/temp57"
path_to_calc_point_clouds="../../datas/artificial_datas/intraday/flex_ohlcv/1min/temp57"
num_simulations=100
...
num_points=1000
results_save_path="ot_result57.csv"
