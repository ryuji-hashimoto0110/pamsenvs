...
config_path="vf_alpha20.json"
specific_name="vf_alpha20"
txts_path="../../datas/artificial_datas/flex_txt/asymmetric_volatility/vf_alpha20"
num_simulations=1500
resample_rule="1min"
tick_dfs_path="../../datas/artificial_datas/flex_csv/asymmetric_volatility/vf_alpha20"
ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/1min/asymmetric_volatility/vf_alpha20"
...
figs_save_path="../../imgs/asymmetric_volatility/vf_alpha20"
results_save_path="../../stylized_facts/results/asymmetric_volatility/vf_alpha20.csv"
