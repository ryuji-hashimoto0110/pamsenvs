...
resample_rule="1min"
tick_dfs_path="../../datas/artificial_datas/flex_csv/asymmetric_volatility/afcn_vf_alpha10_af10"
ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/1min/asymmetric_volatility/afcn_vf_alpha10_af10"
...
figs_save_path="../../imgs/asymmetric_volatility/afcn_vf_alpha10_af10"
results_save_path="../../stylized_facts/results/asymmetric_volatility/afcn_vf_alpha10_af10.csv"
