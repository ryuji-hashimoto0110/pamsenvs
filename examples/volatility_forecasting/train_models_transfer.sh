...
batch_size=512
num_workers=2
load_name="transformer_afcn_random_best.pth"
best_save_name="transformer_afcn_random_aapl2017_best.pth"
last_save_name="transformer_afcn_random_aapl2017_last.pth"
seed=42
