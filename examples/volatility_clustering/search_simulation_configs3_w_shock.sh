...
temp_all_time_ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/all_time/temp3_w_shock"
path_to_calc_point_clouds="../../datas/artificial_datas/intraday/flex_ohlcv/1min/temp3_w_shock"
num_simulations=100
...
num_points=1000
results_save_path="ot_result3_w_shock.csv"
