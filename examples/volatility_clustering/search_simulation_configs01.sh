...
lags="1 10 20 30 50 70 100 200 300" 

initial_seed=42
base_config_path="base_config01.json"
target_variables_config_path="target_variables_config01.json"
temp_txts_path="../../datas/artificial_datas/flex_txt/temp01"
temp_tick_dfs_path="../../datas/artificial_datas/flex_csv/temp01"
temp_ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/1min/temp01"
temp_all_time_ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/all_time/temp01"
path_to_calc_point_clouds="../../datas/artificial_datas/intraday/flex_ohlcv/1min/temp01"
num_simulations=100
...
num_points=1000
results_save_path="ot_result01.csv"
