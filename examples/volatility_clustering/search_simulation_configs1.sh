...
initial_seed=42
base_config_path="base_config0123.json"
target_variables_config_path="target_variables_config1.json"
temp_txts_path="../../datas/artificial_datas/flex_txt/temp1"
temp_tick_dfs_path="../../datas/artificial_datas/flex_csv/temp1"
temp_ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/1min/temp1"
temp_all_time_ohlcv_dfs_path="../../datas/artificial_datas/intraday/flex_ohlcv/all_time/temp1"
path_to_calc_point_clouds="../../datas/artificial_datas/intraday/flex_ohlcv/1min/temp1"
num_simulations=100
