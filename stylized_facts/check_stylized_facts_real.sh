...
new_ohlcv_folder_path="../datas/real_datas/intraday/flex_ohlcv/1min/4568"
transactions_save_folder_path="../datas/real_datas/intraday/flex_transactions/1min/4568"
